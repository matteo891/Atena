...
| `src/talos/vgp/__init__.py` | ADR-0018 | ADR-0013 | Package marker `vgp/` (inaugurato CHG-2026-04-30-027); re-export `is_vetoed_by_roi`, `DEFAULT_ROI_VETO_THRESHOLD`, `min_max_normalize` (CHG-2026-04-30-034) |
