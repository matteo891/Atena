...
> **Ultimo aggiornamento:** 2026-05-01 round 4 — **Motore asin_resolver applicativo live: descrizione+prezzo → ASIN end-to-end ratificato empirically**. HEAD `b3d7735` (CHG-017 backfill). Tag: 7 milestone + 13 checkpoint (`checkpoint/2026-05-01-13` su `4691bd4`; checkpoint-14 in proposta dopo CHG-018). **740 test PASS, 0 SKIPPED** (616 unit/gov/golden + 124 integration; +12 unit asin_resolver_live + 1 live integration). Catena CHG 2026-05-01: 001..018. **Catalogo eventi canonici ADR-0021: 10/11 viventi**. **Indice GitNexus stale ~5 commit** (refresh fine sessione). **Blocco asin_resolver: 3/5 CHG** (016 skeleton + 017 SERP live + 018 composer live). Restano: 019 cache `description_resolutions` (DB), 020 UI rifondata.
...
| ~~CHG-2026-05-01-018~~ | ~~`_LiveAsinResolver` composer end-to-end~~ | Chiuso 2026-05-01 round 4 — 740 PASS (+13: 12 unit + 1 live e2e). Galaxy S24 256GB @ €549 risolto live, ~3 token Keepa. 5° CHG significativo round 4 → checkpoint-14 in proposta. | — |
