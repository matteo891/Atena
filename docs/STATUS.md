...
- **CHG-2026-05-01-009** `TBD`: bulk wrapper `lookup_products(asin_list, ...)` list-comprehension su `lookup_product`. Fail-fast su rate-limit/transient. Empty list = no-op. +4 test unit. **655 PASS**.
