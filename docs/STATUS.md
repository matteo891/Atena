...
> **Ultimo aggiornamento:** 2026-05-01 round 5+ — **CHG-024..028: telemetria additiva UI + cache + 2 caption UX + 1 refactor DRY**. HEAD `57ab540`. **826 test PASS** (688 unit/gov/golden + 138 integration con live attivi end-to-end; +29 test rispetto a CHG-023). **Catalogo eventi canonici ADR-0021: 17/17 voci** (CHG-024+025). 2 KPI live nel caption flow descrizione+prezzo (CHG-026/027). DRY helper `count_eligible_for_overrides` (CHG-028). **Indice GitNexus fresh** (4770 nodes). Modalità "macina" round 5+ è clausola di sessione, **NON persiste**. Tag: **8 milestone** + **15 checkpoint**; 5 CHG significativi dal checkpoint-15 → **soglia raggiunta, checkpoint-16 in creazione** post-backfill questo aggiornamento.
