...
> **Ultimo aggiornamento:** 2026-05-01 round 5+ — **CHG-024+025 telemetria additiva UI + cache** (errata ADR-0021 catalogo 13→17 voci). HEAD `f3bf58c`. **806 test PASS** (668 unit/gov/golden + 138 integration con live attivi end-to-end; +9 test rispetto a CHG-023). **Catalogo eventi canonici ADR-0021: 17/17 voci** (CHG-024 `ui.override_applied`+`ui.resolve_failed`; CHG-025 `cache.hit`+`cache.miss`). **Indice GitNexus fresh** (4770 nodes / 6213 edges / 88 clusters / 16 flows). Modalità "macina" round 5+ è clausola di sessione, **NON persiste**. Tag: **8 milestone** + **15 checkpoint** (`checkpoint/2026-05-01-15` su `4c822f4`); 2 CHG significativi dal checkpoint-15 (soglia: 5).
