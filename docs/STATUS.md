...
> **Ultimo aggiornamento:** 2026-04-30 — commit `4dcca3c` (CHG-008 sessions + initial migration). Tag: `milestone/stack-frozen-v0.9.0` + `checkpoint/2026-04-30-01`. Catena CHG odierna: 001→002→003→004→005→006→007→008
