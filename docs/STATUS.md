...
- **CHG-2026-05-01-007** `TBD`: `SamsungExtractor.match(*, asin: str | None = None)` kwarg propaga l'asin reale a `extract.kill_switch.extra["asin"]` (catalogo ADR-0021). Backward compat strict (default None → sentinel `<n/a>`). +2 test caplog. **641 PASS**.
