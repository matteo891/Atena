...
> **Ultimo aggiornamento:** 2026-05-01 round 4 — **Cache persistente description_resolutions chiusa + 4° tabella post Allegato A + drift ORM idx_config_unique risolto**. HEAD `162afed` (CHG-018 backfill, checkpoint-14 su `162afed`). Tag: 7 milestone + **14 checkpoint** (`checkpoint/2026-05-01-14`). **749 test PASS, 0 SKIPPED** (616 unit/gov/golden + 133 integration; +10 nuovi test repository, +12 unit asin_resolver_live + 1 live integration vs CHG-017). Catena CHG 2026-05-01: 001..019. **Catalogo eventi canonici ADR-0021: 10/11 viventi**. **Indice GitNexus stale ~10 commit** (refresh fine sessione). **Blocco asin_resolver: 4/5 CHG** (016 skeleton + 017 SERP + 018 composer + 019 cache). Resta: 020 UI rifondata.
