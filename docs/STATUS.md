...
> **Ultimo aggiornamento:** 2026-05-01 round 5 — **hardening flow descrizione+prezzo CHG-020 chiuso 3/3 (A1+A2+A3)**: telemetria UI (CHG-021), `verified_buybox_eur` separato da `cost_eur` (CHG-022), override candidato manuale top-N per ambigui (CHG-023). HEAD `d699111`. **792 test PASS** (659 unit/gov/golden + 133 integration). **Catalogo eventi canonici ADR-0021: 13/13 voci**. Modalità "macina" round 5 attiva (clausola di sessione, non persiste). 3 CHG significativi macinati → soglia checkpoint raggiunta (CHG-021..023): proposta `checkpoint/2026-05-01-15` imminente. Tag invariati: **8 milestone** + **14 checkpoint**.
