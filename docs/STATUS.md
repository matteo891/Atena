...
> **Ultimo aggiornamento:** 2026-05-01 — commit `[pending]` (feat: OcrPipeline skeleton CHG-2026-05-01-003). Tag: 4 milestone + 10 checkpoint. Catena CHG 2026-04-30: 001→059 (chiusa). Catena CHG 2026-05-01: 001..**003** (in corso). **Tabelle Allegato A coperte: 10/10** ✓ + **578 test PASS** (478 unit/gov/golden + 100 integration). **Indice GitNexus** stale ~5 commit.
