...
> **Ultimo aggiornamento:** 2026-05-01 round 5 chiusura — **hardening flow descrizione+prezzo CHG-020 chiuso 3/3 (A1+A2+A3) + checkpoint-15 + GitNexus reindex**: telemetria UI (CHG-021), `verified_buybox_eur` separato da `cost_eur` (CHG-022), override candidato manuale top-N per ambigui (CHG-023). HEAD `b46b9ef` (post backfill CHG-022). **792 test PASS** (659 unit/gov/golden + 133 integration). **Catalogo eventi canonici ADR-0021: 13/13 voci**. **Indice GitNexus fresh** (4769 nodes / 6213 edges / 87 clusters / 16 flows — refreshed fine round 5 dopo CHG-021..023). Modalità "macina" round 5 era clausola di sessione, **NON persiste**. Memory `project_session_handoff_2026-05-01-round5.md` puntatore di re-entry post-/clear. Tag: **8 milestone** + **15 checkpoint** (`checkpoint/2026-05-01-15` su `4c822f4`).
