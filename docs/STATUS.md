...
> **Ultimo aggiornamento:** 2026-05-01 round 5+ — **CHG-024..027: telemetria additiva UI + cache + 2 caption UX (hit rate cache + rate buybox verificato)**. HEAD `ace3f97`. **820 test PASS** (682 unit/gov/golden + 138 integration con live attivi end-to-end; +23 test rispetto a CHG-023). **Catalogo eventi canonici ADR-0021: 17/17 voci** (CHG-024 `ui.override_applied`+`ui.resolve_failed`; CHG-025 `cache.hit`+`cache.miss`). 2 KPI live nel caption flow descrizione+prezzo (CHG-026 cache + CHG-027 buybox). **Indice GitNexus fresh** (4770 nodes / 6213 edges / 88 clusters / 16 flows). Modalità "macina" round 5+ è clausola di sessione, **NON persiste**. Tag: **8 milestone** + **15 checkpoint** (`checkpoint/2026-05-01-15` su `4c822f4`); 4 CHG significativi dal checkpoint-15 (soglia: 5 — prossimo CHG triggera proposta checkpoint-16).
