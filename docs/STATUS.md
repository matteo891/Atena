...
> **Ultimo aggiornamento:** 2026-04-30 — commit `e4f4071` (chore: nota stima MVP + ordine blocchi nel campo Nota al Prossimo Claude, pre-clear). Tag: `milestone/stack-frozen-v0.9.0` + **`milestone/first-formula-v1.0.0`** + **5 checkpoint** (01..05 target `cf11e6c`). Catena CHG odierna: 001→...→033. **Tabelle Allegato A coperte: 10/10** ✓ + **258 test PASS** (237 unit/governance + 21 integration). **Indice GitNexus operativo** (1825 / 2113 / 13 / 4).
