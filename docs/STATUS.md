...
> **Ultimo aggiornamento:** 2026-04-30 — commit `cc2ad25` (chore backfill CHG-029 + STATUS + sync GitNexus). Tag: `milestone/stack-frozen-v0.9.0` + **4 checkpoint** (01 / 02 / 03 / 04 target `3a5e2ed`). Catena CHG odierna: 001→...→029. **Tabelle Allegato A coperte: 10/10** ✓ + **242 test PASS** (221 unit/governance + 21 integration). **Indice GitNexus operativo** (1825 / 2113 / 13 / 4).
