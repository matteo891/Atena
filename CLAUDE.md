...
This project is indexed by GitNexus as **Atena** (4769 symbols, 6213 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
