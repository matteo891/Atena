...
| 18 | Terza tabella Allegato A: probabilmente `listino_items` (FK → sessions + asin_master), primo modello con FK | ADR-0015 | Prossimo |
| 19 | Ratifica/risoluzione open-question "DEFAULT → NOT NULL" su Allegato A | ADR-0015 (errata) | Discussione Leader |
