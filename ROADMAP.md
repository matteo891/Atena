...
| 20 | Quarta tabella Allegato A: `config_overrides` (primo modello con RLS + indice UNIQUE composito) | ADR-0015 | **In corso** (CHG-2026-04-30-012) |
| 21 | Tabelle restanti Allegato A (6/10): `vgp_results` (FK doppia), `cart_items`, `panchina_items`, `storico_ordini` (RLS), `locked_in` (RLS), `audit_log` | ADR-0015 | Da pianificare |
