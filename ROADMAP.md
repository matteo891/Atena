...
| 7 | Esposizione bozza dal Leader → riempimento PROJECT-RAW.md `Draft → Iterating` | ADR-0012 | Round 1+2+3+4+5 (CHG-004/005/006/007/008). **0 lacune aperte (26/26 chiuse).** Sweep completato — in attesa della dichiarazione esplicita di Frozen |
| 8 | `Frozen` PROJECT-RAW.md → proposta scomposizione (Claude) → validazione Leader → ADR di stack | ADR-0012, ADR di stack da promulgare | Sbloccabile dopo dichiarazione esplicita di Frozen |
