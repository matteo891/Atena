...
| 19 | Terza tabella Allegato A: `listino_items` (primo modello con FK + relationship bidirezionale + ON DELETE CASCADE) | ADR-0015 | **In corso** (CHG-2026-04-30-011) |
| 20 | Tabelle restanti Allegato A (7/10): `vgp_results`, `cart_items`, `panchina_items`, `storico_ordini` (RLS), `locked_in` (RLS), `config_overrides` (RLS), `audit_log` | ADR-0015 | Da pianificare |
