...
| 23 | Sesta tabella Allegato A: `cart_items` (carrello Tetris finale, doppia FK CASCADE, locked_in R-04) | ADR-0015, ADR-0018 | **In corso** (CHG-2026-04-30-014) |
| 24 | Tabelle restanti Allegato A (4/10): `panchina_items` (FK doppia, R-09), `storico_ordini` (RLS + FK), `locked_in` (RLS standalone, R-04), `audit_log` (append-only) | ADR-0015 | Da pianificare |
