...
| 21 | Quinta tabella Allegato A: `vgp_results` (nucleo decisore, doppia FK CASCADE, indice `(session_id, vgp_score DESC)`) | ADR-0015, ADR-0018 | **In corso** (CHG-2026-04-30-013) |
| 22 | Tabelle restanti Allegato A (5/10): `cart_items` (FK su vgp_results), `panchina_items` (FK su vgp_results), `storico_ordini` (RLS + FK), `locked_in` (RLS), `audit_log` (append-only) | ADR-0015 | Da pianificare |
