...
| 18 | Errata Corrige ADR-0015: ratifica regola "DEFAULT → NOT NULL" (risoluzione (a) del Leader) | ADR-0015, ADR-0009 | **In corso** (CHG-2026-04-30-010) |
| 19 | Terza tabella Allegato A: `listino_items` (primo modello con FK → sessions + asin_master) | ADR-0015 | Programmato post-CHG-010 |
