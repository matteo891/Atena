...
| 16 | Primo modello concreto: `AnalysisSession` (tabella `sessions` Allegato A) + initial migration Alembic offline-validated | ADR-0015 | **In corso** (CHG-2026-04-30-008) |
| 17 | Prossima tabella Allegato A (probabilmente `asin_master` lookup indipendente, oppure `listino_items` FK→sessions) | ADR-0015 | Prossimo |
